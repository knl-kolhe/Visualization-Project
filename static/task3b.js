...
function task3b(data) {
    ...
    var originalMDSEu = data["0"]["0"]
    var dataOriginalY = data["0"]["1"]

    var randomMDSEu = data["0"]["2"]
    var dataRandomY = data["0"]["3"]

    var stratMDSEu = data["0"]["4"]
    var dataStratY = data["0"]["5"]

    var originalMDSCo = data["0"]["6"]
    var dataOriginalY = data["0"]["7"]

    var randomMDSCo = data["0"]["8"]
    var dataRandomY = data["0"]["9"]

    var stratMDSCo = data["0"]["10"]
    var dataStratY = data["0"]["11"]
    ...
    lineChart(originalMDSEu, dataOriginalY, "MDS Euclidian Original 2D scatterplot")

    lineChart(randomMDSEu, dataRandomY, "MDS Euclidian Random Sampled 2D scatterplot")

    lineChart(stratMDSEu, dataStratY, "MDS Euclidian Stratified Sampled 2D scatterplot")

    lineChart(originalMDSCo, dataOriginalY, "MDS Correlation Original 2D scatterplot")

    lineChart(randomMDSCo, dataRandomY, "MDS Correlation Random Sampled 2D scatterplot")

    lineChart(stratMDSCo, dataStratY, "MDS Correlation Stratified Sampled 2D scatterplot")
